...
//@Disabled
public class MoveStraightUsingIMUExampleCode extends LinearOpMode
{
    DcMotor                 leftMotor, rightMotor, bleftMotor, brightMotor;
    //TouchSensor             touch;
    BNO055IMU               imu;
    ...
    {
        leftMotor = hardwareMap.dcMotor.get("main2");
        rightMotor = hardwareMap.dcMotor.get("minor2");
        bleftMotor = hardwareMap.dcMotor.get("main1");
        brightMotor = hardwareMap.dcMotor.get("minor1");
        ...
        while (opModeIsActive())
        {
            ...
            bleftMotor.setPower(power - correction);
            rightMotor.setPower(power + correction);
            brightMotor.setPower(power + correction);
